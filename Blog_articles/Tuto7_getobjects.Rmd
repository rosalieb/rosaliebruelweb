...
<img src="images/Tuto7/Screenshot1.PNG" style="width:80%; margin-right: 5px; margin-bottom: 5px; margin-top: 5px" align="center"/>

It does work well: with `get.objects()`, I do find the 3 objects I just created. On the following line, I am able to remove these objects, but also include exception (e.g., if I want to keep p1 for example.)
