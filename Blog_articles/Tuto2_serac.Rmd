...
We are sharing within the package some example data from Lake Allos (France). You can use those to follow along, or based the input format on them. The publication by Wilhelm *et al* (2012) is accessible <a href=https://www.sciencedirect.com/science/article/pii/S0033589412000294 target="_blank">here</a>. <br>
