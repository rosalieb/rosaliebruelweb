...
.active, .collapsible:hover {
  color: #FFFFFF; 
  background-color: #777; <!-- put back to #ccc if want simple color-->
}
...
<!-- First twitter section collapsible -->

<h3><button type="button" class="collapsible">Science</button></h3>
<div class="content">
  <div class="row">
  <div class="column">
...
<!-- Second twitter section collapsible -->
<h3><button type="button" class="collapsible"> Life at the lab </button></h3>
<div class="content">
...
<!-- Third twitter section collapsible -->
<h3><button type="button" class="collapsible"> Public outreach </button></h3>
<div class="content">
