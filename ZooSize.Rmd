...
<a href="files/LakeName_ZooSize.xlsx" target="_blank"><button class="btn"><i class="fa fa-download"></i> Download the data template</button></a> <img alt="DataCallForm" src="images/icons/excel.png" width="56.25" height="67.5">
