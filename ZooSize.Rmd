...
Read more about our question, the data requirements, and authors guidelines in our <a href="files/CollaborationGuidelines_ZooSize.pdf" target="_blank">collaboration guidelines (click here to read in browser)</a>. Download the collaboration guidelines (.pdf) and data call form (.xslx) by clicking on the buttons below. Email me or one of the other project champions (Lauren Barth and Maria Calderó-Pascual) for an example on how to fill in the data call if necessary.

<a download="files/CollaborationGuidelines_ZooSize.pdf" target="_blank"><button class="btn"><i class="fa fa-download"></i> Download the data call instructions and authors guidelines</button>  </a><img alt="DataCallForm" src="images/icons/adobe_pdf.png" width="43.75" height="52.5">

<a download="files/LakeName_ZooSize.xlsx" target="_blank"><button class="btn"><i class="fa fa-download"></i> Download the data call form</button></a> <img alt="DataCallForm" src="images/icons/excel.png" width="56.25" height="67.5">
