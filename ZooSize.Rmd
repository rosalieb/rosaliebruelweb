...
<a href="files/ZooSize_SOP_v1.0.pdf" target="_blank" title="Download the SOP"><button class="btn"><i class="fa fa-download"></i> Download the SOP</button>  </a><img alt="DataCallForm" src="images/icons/adobe_pdf.png" width="43.75" height="52.5">
