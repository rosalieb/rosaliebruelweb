...
<a href="files/ZooSize_SOP_v1.0.pdf" target="_blank" title="Download the SOP"><button class="btn"><i class="fa fa-download"></i>SOP</button>  </a><img alt="DataCallForm" src="images/icons/adobe_pdf.png" width="43.75" height="52.5">
...
<table id="myTable">
  ...
  <tr>
    ...
    <td>2022-01-25</td>
    <td>Meeting</td>
    <td>ZooSize 5th general meeting - update on the data call, feedback on the SOP, discuss future tasks (QC measurements group, data analysis group).</td>
  </tr>
</table> 
